...
export default function Forgot() {
  ...
  const sendOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch('https://backend-omega-teal.vercel.app/api/auth/forgot-otp', {
        method: 'POST',
  ...
  const resetWithOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch('https://backend-omega-teal.vercel.app/api/auth/reset-with-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
